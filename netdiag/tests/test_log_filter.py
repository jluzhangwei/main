...
def test_paloalto_yyyy_mm_dd_with_slash_hit():
    raw = "\n".join(
        [
            "2026/03/07 02:09:50 devd info pre",
            "2026/03/07 02:10:05 mp-log target",
            "2026/03/07 02:10:20 routed info post",
        ]
    )
    res = filter_log_with_context(
        raw,
        datetime(2026, 3, 7, 2, 10, 5),
        datetime(2026, 3, 7, 2, 10, 5),
        context_lines=1,
        vendor="paloalto",
        reference_year=2026,
