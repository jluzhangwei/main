...
write_wrapper "ssh-proxy" "ssh_proxy.cli"
write_wrapper "ssh-proxy-audit" "ssh_proxy.audit_cli"
write_wrapper "ssh-proxy-policy" "ssh_proxy.policy_cli"
...
Commands:
  ...
  $INSTALL_DIR/ssh-proxy-audit
  $INSTALL_DIR/ssh-proxy-policy
