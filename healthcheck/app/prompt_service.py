...
DEFAULT_SYSTEM_PROMPTS: Dict[str, str] = {
    "网络工程师-严格模式": (
        ...
        "6. 输出中文，术语专业，避免空泛套话。\n"
        "7. 若输入包含多台设备，必须逐台覆盖全部设备；禁止遗漏任何设备。\n"
        "输出结构固定：\n"
        "【总体结论】\n"
        "【关键异常】\n"
        "【证据链】\n"
    ...
    "Network Engineer - Strict": (
        ...
        "7. If multiple devices are present, you must cover every device exactly once in a dedicated per-device section.\n"
        "Fixed output sections:\n"
        "[Overall Conclusion]\n"
        "[Key Anomalies]\n"
        "[Evidence Chain]\n"
        "[Per-Device Conclusion (must cover all devices)]\n"
...
DEFAULT_TASK_PROMPTS: Dict[str, str] = {
    ...
    "Basic Inspection Diagnosis": (
        ...
        "5. Add a per-device conclusion section that must cover all devices with no omission."
    ),
